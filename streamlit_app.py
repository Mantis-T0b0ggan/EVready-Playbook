...
with tab1:
            ...
            try:
                ...
                try:
                    ...
                    if not other_schedules_data:
                        ...
                        # Initialize the session state for selected_comparison_schedules if it doesn't exist
                        ...
                        if selected_comparison_schedules:
                            try:
                                ...
                                df, best_rate_id, projected_best = create_comparison_dataframe(comparison_results)
                                ...
                                st.info("Try selecting your schedules again or check your inputs.")
                ...
                st.info("Please check your inputs and try again, or use the Reset All button at the top to start fresh.")
        try:
            # Get utilities in the selected state that have schedules
            utilities_with_schedules = supabase.from_("Schedule_Table").select("UtilityID").execute()
            utility_ids = [item['UtilityID'] for item in utilities_with_schedules.data]
    ...
    if selected_schedule_id and ((has_energy_charges and usage_kwh is not None) or not has_energy_charges) and ((has_demand_charges and demand_kw is not None) or not has_demand_charges):
        ...
        with calc_col1:
            calculate_pressed = st.button("Calculate Bill Estimate")
        ...
        if calculate_pressed or st.session_state.bill_calculated:
            ...
            try:
                ...
                if not other_schedules_data:
                    ...
                    with comp_col1:
                        compare_pressed = st.button("Compare Rates")
